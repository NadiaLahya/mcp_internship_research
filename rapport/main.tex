...
\subsection{Hallucinations et "folie" de l'IA}
...
\section{Résultats et performance}
    ...
    \subsection{Exemple de notification Discord générée}
    Le système génère automatiquement un rapport formaté pour Discord (cf. Annexe B en \ref{Discord})
...
\clearpage
\section{Annexes}
\subsection{Annexe A - Capture du workflow n8n complet} 
    \begin{figure}[h!]
        \centering
        \includegraphics[width=1\linewidth]{images/complete_workflow.png}
        \caption{Capture du workflow n8n complet}
    \end{figure}

\subsection{Annexe B - Notification Discord}  \label{Discord}
    \begin{figure}[h!]
        \centering
